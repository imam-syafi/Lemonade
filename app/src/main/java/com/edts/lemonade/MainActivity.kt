...
class MainActivity : AppCompatActivity() {
    ...
    private val resourceMap = mapOf(
        SELECT to Resource(R.string.lemon_select, R.drawable.lemon_tree),
        SQUEEZE to Resource(R.string.lemon_squeeze, R.drawable.lemon_squeeze),
        DRINK to Resource(R.string.lemon_drink, R.drawable.lemon_drink),
        RESTART to Resource(R.string.lemon_empty_glass, R.drawable.lemon_restart),
    )
    ...
    private fun setViewElements() {
        ...
        val (stringRes, drawableRes) = requireNotNull(resourceMap[lemonadeState])

        // TODO: for each state, the textAction TextView should be set to the corresponding string from
        //  the string resources file. The strings are named to match the state
        textAction.setText(stringRes)
